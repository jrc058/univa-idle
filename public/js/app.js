...
const ORBIT_RADII = [0, 80, 160, 240];
...
const TECH_DEFINITIONS = {
  ...
  materials_iron: {
    ...
    branch: 'materials',
    tier: 0,
    position: { x: -320.0, y: 0.0, group: 'materials_tier1', orbit: 1, orbitIndex: 0 },
  ...
  materials_aluminum: {
    ...
    branch: 'materials',
    tier: 0,
    position: { x: -360.0, y: 69.3, group: 'materials_tier1', orbit: 1, orbitIndex: 1 },
    requirements: { reach: 1e6, techs: ['materials_metallurgy'] },
    cost: { info: 600 },
    bonus: { matterRate: 1.03 },
  },
  materials_copper: {
    ...
    branch: 'materials',
    tier: 0,
    position: { x: -440.0, y: 69.3, group: 'materials_tier1', orbit: 1, orbitIndex: 2 },
  ...
  materials_semiconductors: {
    ...
    branch: 'materials',
    tier: 0,
    position: { x: -480.0, y: 0.0, group: 'materials_tier1', orbit: 1, orbitIndex: 3 },
  ...
  materials_silicon: {
    ...
    branch: 'materials',
    tier: 0,
    position: { x: -440.0, y: -69.3, group: 'materials_tier1', orbit: 1, orbitIndex: 4 },
  ...
  materials_doping: {
    ...
    branch: 'materials',
    tier: 0,
    position: { x: -700.0, y: 0.0, group: 'materials_tier2', orbit: 0, orbitIndex: 0 },
  ...
  materials_alloys: {
    ...
    branch: 'materials',
    tier: 0,
    position: { x: -620.0, y: 0.0, group: 'materials_tier2', orbit: 1, orbitIndex: 0 },
  ...
  materials_steel: {
    ...
    branch: 'materials',
    tier: 0,
    position: { x: -660.0, y: 69.3, group: 'materials_tier2', orbit: 1, orbitIndex: 1 },
  ...
  materials_titanium: {
    ...
    branch: 'materials',
    tier: 0,
    position: { x: -740.0, y: 69.3, group: 'materials_tier2', orbit: 1, orbitIndex: 2 },
  ...
  materials_superalloys: {
    ...
    branch: 'materials',
    tier: 0,
    position: { x: -780.0, y: 0.0, group: 'materials_tier2', orbit: 1, orbitIndex: 3 },
  ...
  materials_composites: {
    ...
    branch: 'materials',
    tier: 0,
    position: { x: -1000.0, y: 0.0, group: 'materials_tier3', orbit: 0, orbitIndex: 0 },
    requirements: { reach: 3.5e6, techs: ['materials_alloys'] },
    cost: { info: 2500 },
    bonus: { matterRate: 1.06 },
  },
  materials_carbon_fiber: {
    ...
    branch: 'materials',
    tier: 0,
    position: { x: -920.0, y: 0.0, group: 'materials_tier3', orbit: 1, orbitIndex: 0 },
  ...
  materials_ceramics: {
    ...
    branch: 'materials',
    tier: 0,
    position: { x: -960.0, y: 69.3, group: 'materials_tier3', orbit: 1, orbitIndex: 1 },
    requirements: { reach: 4e6, techs: ['materials_composites'] },
    cost: { info: 2800 },
    bonus: { matterRate: 1.04 },
  },
  ...
  materials_nanotech: {
    ...
    branch: 'materials',
    tier: 0,
    position: { x: -1040.0, y: 69.3, group: 'materials_tier3', orbit: 1, orbitIndex: 2 },
  ...
  materials_graphene: {
    ...
    branch: 'materials',
    tier: 0,
    position: { x: -1080.0, y: 0.0, group: 'materials_tier3', orbit: 1, orbitIndex: 3 },
  ...
  materials_carbon_nanotubes: {
    ...
    branch: 'materials',
    tier: 0,
    position: { x: -1300.0, y: 0.0, group: 'materials_tier4', orbit: 0, orbitIndex: 0 },
    requirements: { reach: 9e6, techs: ['materials_nanotech'] },
    cost: { info: 6000 },
    bonus: { matterRate: 1.06 },
  },
  materials_quantum_dots: {
    ...
    branch: 'materials',
    tier: 0,
    position: { x: -1220.0, y: 0.0, group: 'materials_tier4', orbit: 1, orbitIndex: 0 },
  ...
  materials_programmable: {
    ...
    branch: 'materials',
    tier: 0,
    position: { x: -1260.0, y: 69.3, group: 'materials_tier4', orbit: 1, orbitIndex: 1 },
  ...
  materials_shape_memory: {
    ...
    branch: 'materials',
    tier: 0,
    position: { x: -1340.0, y: 69.3, group: 'materials_tier4', orbit: 1, orbitIndex: 2 },
  ...
  materials_self_healing: {
    ...
    branch: 'materials',
    tier: 0,
    position: { x: -1380.0, y: 0.0, group: 'materials_tier4', orbit: 1, orbitIndex: 3 },
    requirements: { reach: 3.5e7, techs: ['materials_programmable'] },
    cost: { info: 18000 },
    bonus: { matterRate: 1.08 },
  },
  materials_metamaterials: {
    ...
    branch: 'materials',
    tier: 0,
    position: { x: -1600.0, y: 0.0, group: 'materials_tier5', orbit: 0, orbitIndex: 0 },
  ...
  materials_exotic: {
    ...
    branch: 'materials',
    tier: 0,
    position: { x: -1520.0, y: 0.0, group: 'materials_tier5', orbit: 1, orbitIndex: 0 },
  ...
  materials_negative_mass: {
    ...
    branch: 'materials',
    tier: 0,
    position: { x: -1560.0, y: 69.3, group: 'materials_tier5', orbit: 1, orbitIndex: 1 },
  ...
  materials_strange_matter: {
    ...
    branch: 'materials',
    tier: 0,
    position: { x: -1640.0, y: 69.3, group: 'materials_tier5', orbit: 1, orbitIndex: 2 },
    requirements: { reach: 9e7, techs: ['materials_exotic'] },
    cost: { info: 50000 },
  ...
  computing_transistors: {
    ...
    branch: 'computing',
    tier: 0,
    position: { x: 480.0, y: 0.0, group: 'computing_tier1', orbit: 1, orbitIndex: 0 },
  ...
  computing_integrated_circuits: {
    ...
    branch: 'computing',
    tier: 0,
    position: { x: 440.0, y: 69.3, group: 'computing_tier1', orbit: 1, orbitIndex: 1 },
  ...
  computing_architecture: {
    ...
    branch: 'computing',
    tier: 0,
    position: { x: 360.0, y: 69.3, group: 'computing_tier1', orbit: 1, orbitIndex: 2 },
  ...
  computing_processors: {
    ...
    branch: 'computing',
    tier: 0,
    position: { x: 320.0, y: 0.0, group: 'computing_tier1', orbit: 1, orbitIndex: 3 },
  ...
  computing_memory: {
    ...
    branch: 'computing',
    tier: 0,
    position: { x: 700.0, y: 0.0, group: 'computing_tier2', orbit: 0, orbitIndex: 0 },
    requirements: { reach: 2e6, techs: ['computing_architecture'] },
    cost: { info: 1300 },
    bonus: { infoRate: 1.05 },
  },
  ...
  computing_parallel: {
    ...
    branch: 'computing',
    tier: 0,
    position: { x: 780.0, y: 0.0, group: 'computing_tier2', orbit: 1, orbitIndex: 0 },
  ...
  computing_multicore: {
    ...
    branch: 'computing',
    tier: 0,
    position: { x: 740.0, y: 69.3, group: 'computing_tier2', orbit: 1, orbitIndex: 1 },
  ...
  computing_gpu: {
    ...
    branch: 'computing',
    tier: 0,
    position: { x: 660.0, y: 69.3, group: 'computing_tier2', orbit: 1, orbitIndex: 2 },
    requirements: { reach: 3.5e6, techs: ['computing_parallel'] },
    cost: { info: 2500 },
    bonus: { infoRate: 1.06 },
  },
  ...
  computing_storage: {
    ...
    branch: 'computing',
    tier: 0,
    position: { x: 620.0, y: 0.0, group: 'computing_tier2', orbit: 1, orbitIndex: 3 },
  ...
  computing_ssd: {
    ...
    branch: 'computing',
    tier: 0,
    position: { x: 1000.0, y: 0.0, group: 'computing_tier3', orbit: 0, orbitIndex: 0 },
  ...
  computing_optical: {
    ...
    branch: 'computing',
    tier: 0,
    position: { x: 1080.0, y: 0.0, group: 'computing_tier3', orbit: 1, orbitIndex: 0 },
    requirements: { reach: 4.5e6, techs: ['computing_storage'] },
    cost: { info: 3500 },
    bonus: { infoRate: 1.05 },
  },
  ...
  computing_ai: {
    ...
    branch: 'computing',
    tier: 0,
    position: { x: 1040.0, y: 69.3, group: 'computing_tier3', orbit: 1, orbitIndex: 1 },
  ...
  computing_machine_learning: {
    ...
    branch: 'computing',
    tier: 0,
    position: { x: 960.0, y: 69.3, group: 'computing_tier3', orbit: 1, orbitIndex: 2 },
  ...
  computing_neural_nets: {
    ...
    branch: 'computing',
    tier: 0,
    position: { x: 920.0, y: 0.0, group: 'computing_tier3', orbit: 1, orbitIndex: 3 },
    requirements: { reach: 9e6, techs: ['computing_ai'] },
    cost: { info: 6000 },
    bonus: { infoRate: 1.08 },
  },
  computing_deep_learning: {
    ...
    branch: 'computing',
    tier: 0,
    position: { x: 1300.0, y: 0.0, group: 'computing_tier4', orbit: 0, orbitIndex: 0 },
  ...
  computing_quantum: {
    ...
    branch: 'computing',
    tier: 0,
    position: { x: 1380.0, y: 0.0, group: 'computing_tier4', orbit: 1, orbitIndex: 0 },
  ...
  computing_qubits: {
    ...
    branch: 'computing',
    tier: 0,
    position: { x: 1340.0, y: 69.3, group: 'computing_tier4', orbit: 1, orbitIndex: 1 },
  ...
  computing_quantum_gates: {
    ...
    branch: 'computing',
    tier: 0,
    position: { x: 1260.0, y: 69.3, group: 'computing_tier4', orbit: 1, orbitIndex: 2 },
  ...
  computing_quantum_error: {
    ...
    branch: 'computing',
    tier: 0,
    position: { x: 1600.0, y: 0.0, group: 'computing_tier5', orbit: 0, orbitIndex: 0 },
  ...
  computing_consciousness: {
    ...
    branch: 'computing',
    tier: 0,
    position: { x: 1680.0, y: 0.0, group: 'computing_tier5', orbit: 1, orbitIndex: 0 },
  ...
  computing_brain_interface: {
    ...
    branch: 'computing',
    tier: 0,
    position: { x: 1640.0, y: 69.3, group: 'computing_tier5', orbit: 1, orbitIndex: 1 },
  ...
  computing_mind_upload: {
    ...
    branch: 'computing',
    tier: 0,
    position: { x: 1560.0, y: 69.3, group: 'computing_tier5', orbit: 1, orbitIndex: 2 },
  ...
  energy_photovoltaics: {
    ...
    branch: 'energy',
    tier: 0,
    position: { x: -120.0, y: 346.4, group: 'energy_tier1', orbit: 1, orbitIndex: 0 },
  ...
  energy_solar_panels: {
    ...
    branch: 'energy',
    tier: 0,
    position: { x: -160.0, y: 415.7, group: 'energy_tier1', orbit: 1, orbitIndex: 1 },
  ...
  energy_wind: {
    ...
    branch: 'energy',
    tier: 0,
    position: { x: -240.0, y: 415.7, group: 'energy_tier1', orbit: 1, orbitIndex: 2 },
  ...
  energy_turbines: {
    ...
    branch: 'energy',
    tier: 0,
    position: { x: -280.0, y: 346.4, group: 'energy_tier1', orbit: 1, orbitIndex: 3 },
  ...
  energy_fission_theory: {
    ...
    branch: 'energy',
    tier: 0,
    position: { x: -350.0, y: 606.2, group: 'energy_tier2', orbit: 0, orbitIndex: 0 },
  ...
  energy_uranium_enrichment: {
    ...
    branch: 'energy',
    tier: 0,
    position: { x: -270.0, y: 606.2, group: 'energy_tier2', orbit: 1, orbitIndex: 0 },
  ...
  energy_reactor_design: {
    ...
    branch: 'energy',
    tier: 0,
    position: { x: -310.0, y: 675.5, group: 'energy_tier2', orbit: 1, orbitIndex: 1 },
  ...
  energy_fission_plants: {
    ...
    branch: 'energy',
    tier: 0,
    position: { x: -390.0, y: 675.5, group: 'energy_tier2', orbit: 1, orbitIndex: 2 },
  ...
  energy_fusion_theory: {
    ...
    branch: 'energy',
    tier: 0,
    position: { x: -430.0, y: 606.2, group: 'energy_tier2', orbit: 1, orbitIndex: 3 },
  ...
  energy_plasma_containment: {
    ...
    branch: 'energy',
    tier: 0,
    position: { x: -500.0, y: 866.0, group: 'energy_tier3', orbit: 0, orbitIndex: 0 },
  ...
  energy_magnetic_confinement: {
    ...
    branch: 'energy',
    tier: 0,
    position: { x: -420.0, y: 866.0, group: 'energy_tier3', orbit: 1, orbitIndex: 0 },
  ...
  energy_inertial_confinement: {
    ...
    branch: 'energy',
    tier: 0,
    position: { x: -460.0, y: 935.3, group: 'energy_tier3', orbit: 1, orbitIndex: 1 },
    requirements: { reach: 1e7, techs: ['energy_plasma_containment'] },
    cost: { info: 7000 },
    bonus: { energyRate: 1.08 },
  },
  energy_fusion_reactors: {
    ...
    branch: 'energy',
    tier: 0,
    position: { x: -540.0, y: 935.3, group: 'energy_tier3', orbit: 1, orbitIndex: 2 },
  ...
  energy_antimatter_theory: {
    ...
    branch: 'energy',
    tier: 0,
    position: { x: -580.0, y: 866.0, group: 'energy_tier3', orbit: 1, orbitIndex: 3 },
  ...
  energy_antimatter_production: {
    ...
    branch: 'energy',
    tier: 0,
    position: { x: -650.0, y: 1125.8, group: 'energy_tier4', orbit: 0, orbitIndex: 0 },
  ...
  energy_antimatter_storage: {
    ...
    branch: 'energy',
    tier: 0,
    position: { x: -570.0, y: 1125.8, group: 'energy_tier4', orbit: 1, orbitIndex: 0 },
  ...
  energy_antimatter_reactors: {
    ...
    branch: 'energy',
    tier: 0,
    position: { x: -610.0, y: 1195.1, group: 'energy_tier4', orbit: 1, orbitIndex: 1 },
  ...
  energy_zero_point: {
    ...
    branch: 'energy',
    tier: 0,
    position: { x: -690.0, y: 1195.1, group: 'energy_tier4', orbit: 1, orbitIndex: 2 },
  ...
  energy_vacuum_fluctuations: {
    ...
    branch: 'energy',
    tier: 0,
    position: { x: -800.0, y: 1385.6, group: 'energy_tier5', orbit: 0, orbitIndex: 0 },
  ...
  energy_casimir_effect: {
    ...
    branch: 'energy',
    tier: 0,
    position: { x: -720.0, y: 1385.6, group: 'energy_tier5', orbit: 1, orbitIndex: 0 },
  ...
  biotech_dna_structure: {
    ...
    branch: 'biotech',
    tier: 0,
    position: { x: 280.0, y: 346.4, group: 'biotech_tier1', orbit: 1, orbitIndex: 0 },
  ...
  biotech_protein_synthesis: {
    ...
    branch: 'biotech',
    tier: 0,
    position: { x: 240.0, y: 415.7, group: 'biotech_tier1', orbit: 1, orbitIndex: 1 },
    requirements: { reach: 1.2e6, techs: ['biotech_cell_theory'] },
    cost: { info: 700 },
    bonus: { energyRate: 1.04 },
  },
  ...
  biotech_genetics: {
    ...
    branch: 'biotech',
    tier: 0,
    position: { x: 160.0, y: 415.7, group: 'biotech_tier1', orbit: 1, orbitIndex: 2 },
  ...
  biotech_gene_sequencing: {
    ...
    branch: 'biotech',
    tier: 0,
    position: { x: 120.0, y: 346.4, group: 'biotech_tier1', orbit: 1, orbitIndex: 3 },
  ...
  biotech_genetic_markers: {
    ...
    branch: 'biotech',
    tier: 0,
    position: { x: 350.0, y: 606.2, group: 'biotech_tier2', orbit: 0, orbitIndex: 0 },
  ...
  biotech_gene_editing: {
    ...
    branch: 'biotech',
    tier: 0,
    position: { x: 430.0, y: 606.2, group: 'biotech_tier2', orbit: 1, orbitIndex: 0 },
  ...
  biotech_crispr: {
    ...
    branch: 'biotech',
    tier: 0,
    position: { x: 390.0, y: 675.5, group: 'biotech_tier2', orbit: 1, orbitIndex: 1 },
  ...
  biotech_gene_therapy: {
    ...
    branch: 'biotech',
    tier: 0,
    position: { x: 310.0, y: 675.5, group: 'biotech_tier2', orbit: 1, orbitIndex: 2 },
  ...
  biotech_stem_cells: {
    ...
    branch: 'biotech',
    tier: 0,
    position: { x: 270.0, y: 606.2, group: 'biotech_tier2', orbit: 1, orbitIndex: 3 },
  ...
  biotech_pluripotent: {
    ...
    branch: 'biotech',
    tier: 0,
    position: { x: 500.0, y: 866.0, group: 'biotech_tier3', orbit: 0, orbitIndex: 0 },
  ...
  biotech_regeneration: {
    ...
    branch: 'biotech',
    tier: 0,
    position: { x: 580.0, y: 866.0, group: 'biotech_tier3', orbit: 1, orbitIndex: 0 },
  ...
  biotech_synthetic: {
    ...
    branch: 'biotech',
    tier: 0,
    position: { x: 540.0, y: 935.3, group: 'biotech_tier3', orbit: 1, orbitIndex: 1 },
  ...
  biotech_synthetic_dna: {
    ...
    branch: 'biotech',
    tier: 0,
    position: { x: 460.0, y: 935.3, group: 'biotech_tier3', orbit: 1, orbitIndex: 2 },
  ...
  biotech_synthetic_organisms: {
    ...
    branch: 'biotech',
    tier: 0,
    position: { x: 420.0, y: 866.0, group: 'biotech_tier3', orbit: 1, orbitIndex: 3 },
  ...
  biotech_biofuels: {
    ...
    branch: 'biotech',
    tier: 0,
    position: { x: 650.0, y: 1125.8, group: 'biotech_tier4', orbit: 0, orbitIndex: 0 },
  ...
  biotech_biocomputing: {
    ...
    branch: 'biotech',
    tier: 0,
    position: { x: 730.0, y: 1125.8, group: 'biotech_tier4', orbit: 1, orbitIndex: 0 },
  ...
  biotech_dna_computing: {
    ...
    branch: 'biotech',
    tier: 0,
    position: { x: 690.0, y: 1195.1, group: 'biotech_tier4', orbit: 1, orbitIndex: 1 },
  ...
  biotech_neural_tissue: {
    ...
    branch: 'biotech',
    tier: 0,
    position: { x: 610.0, y: 1195.1, group: 'biotech_tier4', orbit: 1, orbitIndex: 2 },
  ...
  biotech_living_processors: {
    ...
    branch: 'biotech',
    tier: 0,
    position: { x: 570.0, y: 1125.8, group: 'biotech_tier4', orbit: 1, orbitIndex: 3 },
  ...
  biotech_immortality: {
    ...
    branch: 'biotech',
    tier: 0,
    position: { x: 800.0, y: 1385.6, group: 'biotech_tier5', orbit: 0, orbitIndex: 0 },
  ...
  biotech_telomeres: {
    ...
    branch: 'biotech',
    tier: 0,
    position: { x: 880.0, y: 1385.6, group: 'biotech_tier5', orbit: 1, orbitIndex: 0 },
  ...
  biotech_cellular_repair: {
    ...
    branch: 'biotech',
    tier: 0,
    position: { x: 840.0, y: 1454.9, group: 'biotech_tier5', orbit: 1, orbitIndex: 1 },
  ...
  biotech_consciousness_transfer: {
    ...
    branch: 'biotech',
    tier: 0,
    position: { x: 760.0, y: 1454.9, group: 'biotech_tier5', orbit: 1, orbitIndex: 2 },
  ...
  propulsion_solid_fuel: {
    ...
    branch: 'propulsion',
    tier: 0,
    position: { x: -120.0, y: -346.4, group: 'propulsion_tier1', orbit: 1, orbitIndex: 0 },
  ...
  propulsion_liquid_fuel: {
    ...
    branch: 'propulsion',
    tier: 0,
    position: { x: -160.0, y: -277.1, group: 'propulsion_tier1', orbit: 1, orbitIndex: 1 },
  ...
  propulsion_hybrid: {
    ...
    branch: 'propulsion',
    tier: 0,
    position: { x: -240.0, y: -277.1, group: 'propulsion_tier1', orbit: 1, orbitIndex: 2 },
  ...
  propulsion_electric: {
    ...
    branch: 'propulsion',
    tier: 0,
    position: { x: -350.0, y: -606.2, group: 'propulsion_tier2', orbit: 0, orbitIndex: 0 },
  ...
  propulsion_ion_drives: {
    ...
    branch: 'propulsion',
    tier: 0,
    position: { x: -270.0, y: -606.2, group: 'propulsion_tier2', orbit: 1, orbitIndex: 0 },
  ...
  propulsion_hall_effect: {
    ...
    branch: 'propulsion',
    tier: 0,
    position: { x: -310.0, y: -536.9, group: 'propulsion_tier2', orbit: 1, orbitIndex: 1 },
  ...
  propulsion_vasimr: {
    ...
    branch: 'propulsion',
    tier: 0,
    position: { x: -390.0, y: -536.9, group: 'propulsion_tier2', orbit: 1, orbitIndex: 2 },
  ...
  propulsion_nuclear: {
    ...
    branch: 'propulsion',
    tier: 0,
    position: { x: -500.0, y: -866.0, group: 'propulsion_tier3', orbit: 0, orbitIndex: 0 },
  ...
  propulsion_nuclear_thermal: {
    ...
    branch: 'propulsion',
    tier: 0,
    position: { x: -420.0, y: -866.0, group: 'propulsion_tier3', orbit: 1, orbitIndex: 0 },
  ...
  propulsion_nuclear_electric: {
    ...
    branch: 'propulsion',
    tier: 0,
    position: { x: -460.0, y: -796.7, group: 'propulsion_tier3', orbit: 1, orbitIndex: 1 },
  ...
  propulsion_fusion: {
    ...
    branch: 'propulsion',
    tier: 0,
    position: { x: -650.0, y: -1125.8, group: 'propulsion_tier4', orbit: 0, orbitIndex: 0 },
  ...
  propulsion_fusion_drives: {
    ...
    branch: 'propulsion',
    tier: 0,
    position: { x: -570.0, y: -1125.8, group: 'propulsion_tier4', orbit: 1, orbitIndex: 0 },
  ...
  propulsion_antimatter_catalyzed: {
    ...
    branch: 'propulsion',
    tier: 0,
    position: { x: -610.0, y: -1056.5, group: 'propulsion_tier4', orbit: 1, orbitIndex: 1 },
  ...
  propulsion_ftl: {
    ...
    branch: 'propulsion',
    tier: 0,
    position: { x: -800.0, y: -1385.6, group: 'propulsion_tier5', orbit: 0, orbitIndex: 0 },
  ...
  propulsion_alcubierre: {
    ...
    branch: 'propulsion',
    tier: 0,
    position: { x: -720.0, y: -1385.6, group: 'propulsion_tier5', orbit: 1, orbitIndex: 0 },
  ...
  propulsion_warp_field: {
    ...
    branch: 'propulsion',
    tier: 0,
    position: { x: -760.0, y: -1316.3, group: 'propulsion_tier5', orbit: 1, orbitIndex: 1 },
  ...
  sensors_cameras: {
    ...
    branch: 'sensors',
    tier: 0,
    position: { x: 280.0, y: -346.4, group: 'sensors_tier1', orbit: 1, orbitIndex: 0 },
  ...
  sensors_telescopes: {
    ...
    branch: 'sensors',
    tier: 0,
    position: { x: 240.0, y: -277.1, group: 'sensors_tier1', orbit: 1, orbitIndex: 1 },
  ...
  sensors_electromagnetic: {
    ...
    branch: 'sensors',
    tier: 0,
    position: { x: 160.0, y: -277.1, group: 'sensors_tier1', orbit: 1, orbitIndex: 2 },
    requirements: { reach: 1.5e6 },
    cost: { info: 900 },
    bonus: { infoRate: 1.04 },
  },
  sensors_radio: {
    ...
    branch: 'sensors',
    tier: 0,
    position: { x: 120.0, y: -346.4, group: 'sensors_tier1', orbit: 1, orbitIndex: 3 },
  ...
  sensors_radar: {
    ...
    branch: 'sensors',
    tier: 0,
    position: { x: 350.0, y: -606.2, group: 'sensors_tier2', orbit: 0, orbitIndex: 0 },
  ...
  sensors_spectroscopy: {
    ...
    branch: 'sensors',
    tier: 0,
    position: { x: 430.0, y: -606.2, group: 'sensors_tier2', orbit: 1, orbitIndex: 0 },
  ...
  sensors_mass_spec: {
    ...
    branch: 'sensors',
    tier: 0,
    position: { x: 390.0, y: -536.9, group: 'sensors_tier2', orbit: 1, orbitIndex: 1 },
  ...
  sensors_infrared: {
    ...
    branch: 'sensors',
    tier: 0,
    position: { x: 310.0, y: -536.9, group: 'sensors_tier2', orbit: 1, orbitIndex: 2 },
    requirements: { reach: 3.5e6, techs: ['sensors_spectroscopy'] },
    cost: { info: 2500 },
    bonus: { infoRate: 1.04 },
  },
  ...
  sensors_particle: {
    ...
    branch: 'sensors',
    tier: 0,
    position: { x: 270.0, y: -606.2, group: 'sensors_tier2', orbit: 1, orbitIndex: 3 },
  ...
  sensors_scintillators: {
    ...
    branch: 'sensors',
    tier: 0,
    position: { x: 500.0, y: -866.0, group: 'sensors_tier3', orbit: 0, orbitIndex: 0 },
  ...
  sensors_cloud_chambers: {
    ...
    branch: 'sensors',
    tier: 0,
    position: { x: 580.0, y: -866.0, group: 'sensors_tier3', orbit: 1, orbitIndex: 0 },
  ...
  sensors_quantum: {
    ...
    branch: 'sensors',
    tier: 0,
    position: { x: 540.0, y: -796.7, group: 'sensors_tier3', orbit: 1, orbitIndex: 1 },
  ...
  sensors_quantum_entanglement: {
    ...
    branch: 'sensors',
    tier: 0,
    position: { x: 460.0, y: -796.7, group: 'sensors_tier3', orbit: 1, orbitIndex: 2 },
  ...
  sensors_atomic_clocks: {
    ...
    branch: 'sensors',
    tier: 0,
    position: { x: 650.0, y: -1125.8, group: 'sensors_tier4', orbit: 0, orbitIndex: 0 },
  ...
  sensors_squid: {
    ...
    branch: 'sensors',
    tier: 0,
    position: { x: 730.0, y: -1125.8, group: 'sensors_tier4', orbit: 1, orbitIndex: 0 },
  ...
  sensors_gravity: {
    ...
    branch: 'sensors',
    tier: 0,
    position: { x: 690.0, y: -1056.5, group: 'sensors_tier4', orbit: 1, orbitIndex: 1 },
  ...
  sensors_ligo: {
    ...
    branch: 'sensors',
    tier: 0,
    position: { x: 610.0, y: -1056.5, group: 'sensors_tier4', orbit: 1, orbitIndex: 2 },
  ...
  sensors_gravitational_waves: {
    ...
    branch: 'sensors',
    tier: 0,
    position: { x: 800.0, y: -1385.6, group: 'sensors_tier5', orbit: 0, orbitIndex: 0 },
  ...
  sensors_dark_matter: {
    ...
    branch: 'sensors',
    tier: 0,
    position: { x: 880.0, y: -1385.6, group: 'sensors_tier5', orbit: 1, orbitIndex: 0 },
  ...
  sensors_wimp: {
    ...
    branch: 'sensors',
    tier: 0,
    position: { x: 840.0, y: -1316.3, group: 'sensors_tier5', orbit: 1, orbitIndex: 1 },
  ...
  sensors_axion: {
    ...
    branch: 'sensors',
    tier: 0,
    position: { x: 760.0, y: -1316.3, group: 'sensors_tier5', orbit: 1, orbitIndex: 2 },
  ...
  dysonEngineering: {
    ...
    branch: 'energy',
    tier: 1,
    position: { x: -760.0, y: 1454.9, group: 'energy_tier5', orbit: 1, orbitIndex: 1 },
  ...
  stellarHarvesting: {
    ...
    branch: 'energy',
    tier: 1,
    position: { x: -840.0, y: 1454.9, group: 'energy_tier5', orbit: 1, orbitIndex: 2 },
  ...
  exoticMatter: {
    ...
    branch: 'materials',
    tier: 1,
    position: { x: -1680.0, y: 0.0, group: 'materials_tier5', orbit: 1, orbitIndex: 3 },
